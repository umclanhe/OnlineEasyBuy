<%-- 
    Document   : dietloginok
    Created on : Dec 6, 2015, 4:35:57 PM
    ...
    <div class="container">
        <div class="header-top">
            <div class="top-menu">
                ...
                <ul>
                    <li><a href="dietloginok.jsp" class="active">Home</a></li>
        ...
        <div class="header-bottom">
            <!-- logo image -->
            <div class="logo">
                <a href="dietloginok.jsp"> <img src="images/logo.png"></a>
            </div>
            <!-- search box -->
            <div class="search">
