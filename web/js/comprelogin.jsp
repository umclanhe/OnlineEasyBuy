<%-- 
    Document   : comprelogin
    Created on : Dec 6, 2015, 4:36:50 PM
                ...
                <div id="login">
                    <div class="container">
                        <div class="text-center">
                            ...
                            <h2>Sorry, Representative, your login status is: 
                            <jsp:getProperty name="nb" property="status" /></h2>
                            <h2>Please re-enter the correct username and password</h2>
			</div>
				<div class="row">
